...
WebUI.setText(findTestObject('Object Repository/cartpage/textfield_recipient_name'), '')
...
WebUI.verifyElementVisible(findTestObject('cartpage/alert_recipient_name'))
