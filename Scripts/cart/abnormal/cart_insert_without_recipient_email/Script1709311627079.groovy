...
WebUI.setText(findTestObject('Object Repository/cartpage/textfield_recipient_name'), sender_name)

WebUI.setText(findTestObject('Object Repository/cartpage/textfield_recipient_email'), '')

WebUI.setText(findTestObject('cartpage/textfield_sender_name'), recipient_name)

WebUI.setText(findTestObject('cartpage/textfield_sender_email'), recipient_email)
