...
WebUI.setText(findTestObject('Object Repository/registerpage/textfield_email'), 'wayanpnm3@gmail.com')
...
WebUI.verifyElementVisible(findTestObject('registerpage/warning_last_name_required'))
