...
WebUI.setText(findTestObject('Object Repository/registerpage/textfield_email'), 'wayanpnm@gmail.com')
...
WebUI.verifyElementVisible(findTestObject('registerpage/warning_used_email'))
